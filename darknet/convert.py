...
wd = getcwd() # /Users/choeyujin/Project/purdue_project/darknet/BBox-Label-Tool

list_file = open('%s/%s.txt'%(wd, cls), 'w')
...
for (dirpath, dirnames, filenames) in walk(mypath):
    ...
    break
print(txt_name_list)    # ['test.txt', 'test2.txt', 'test3.txt']
